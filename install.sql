...
INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, use_function, set_function) VALUES (NULL, 'Piwik Location', 'PIWIK_URL', '', 'Enter your Piwik Analytics base URL. Not the full path to piwik.php, only the folder it is in.', @configuration_group_id, 1, NOW(), NULL, NULL),
